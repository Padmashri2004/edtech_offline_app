...
class SessionManager {
  ...
  Future<void> saveSessionState({
    ...
    required Map<int, String> answers, // questionId -> selectedAnswer
  }) async {
    ...
    await prefs.setString('answers', answers.toString());
  }
  ...
  Future<Map<String, dynamic>?> restoreSessionState() async {
    ...
    return {
      ...
      'answers': prefs.getString('answers') ?? '{}',
    };
  }

  /// Clear session state (after submission or manual exit)
