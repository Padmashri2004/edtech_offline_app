...
class _QuizGenScreenState extends State<QuizGenScreen> {
  ...
  // NEW: Store selected topics passed from previous screen
  ...
  void didChangeDependencies() {
    ...
    if (args != null && _extractedText.isEmpty) {
      ...
      if (args['selection'] != null) {
        // Handle Map<String, List<String>> structure from ChapterListScreen
    ...
    try {
      for (var batch in _batches) {
        ...
        final rawData = await aiRepo.getQuizFromChapter(
          ...
          type: batch.type,
          count: batch.count,
          focusTopics: _selectedTopics, // PASS THE TOPICS HERE
        );
      ...
      if (mounted) {
        ...
        _showSnack(
            "Generated ${allNewQuestions.length} questions from ${_selectedTopics.length} topics.");
      }
    } catch (e) {
      if (mounted) {
  ...
  // ... (Keep existing _addManualQuestion, _showEditDialog, _saveQuiz, _showSnack, _addBatch, _removeBatch, build, _buildBatchCard, _guessType exactly as they were in source)
          ...
          ? Center(
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text("  ⚠️   Please do NOT close the app.",
                      style: TextStyle(
              ...
              children: [
                Expanded(
                  ...
                  child: ListView(
                    ...
                    children: [
                      const Text("Configure Quiz Structure",
                          style: TextStyle(
                      ...
                      if (_selectedTopics.isNotEmpty)
                        Padding(
                          ...
                          child: Text(
                              "Focusing on ${_selectedTopics.length} topics: ${_selectedTopics.join(', ')}",
